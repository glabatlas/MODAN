...
def get_NI_qualified_genes(cancer: str, subtype: str):
    ...
    data_mut_total = pd.read_csv('./datasets/'+cancer+'/'+subtype+'/mut.csv',header=0,index_col=0)
    data_methy_total = pd.read_csv('./datasets_generate/'+cancer+'/'+subtype+'/methy_mut.csv',header=0,index_col=0)
    data_expr_total = pd.read_csv('./datasets_generate/'+cancer+'/'+subtype+'/expr_mut.csv',header=0,index_col=0)
